...
class AutomodelsController extends Controller{
    ...
    public function actionGo($imigrate=false){
        ...
        foreach($aryTables as $oneTable){
            ...
            if(strtolower($tableName) == 'migrate'){
            	echo 'skip table migrate................' . PHP_EOL;
            	continue;
            }
            
            $fileC = '<?php'.PHP_EOL;
            $fileC .= 'namespace app\models;'.PHP_EOL;
            ...
            if(file_exists(dirname(__DIR__).'/models/'.ucfirst($tableName).'Trait.php')){
            ...
            file_put_contents(dirname(__DIR__).'/models/'.ucfirst($tableName).'.php',$fileC);
            ...
            if($imigrate){
            	...
            	echo 'migrate for table '.$tableName.' was build'.PHP_EOL;
